INSERT INTO wall_bracket (id, size, ajustable, name, price) VALUES (1001, '25X32', false, 'LG bracket', 32.23);
INSERT INTO wall_bracket (id, size, ajustable, name, price) VALUES (1002, '25X32/32X40', true, 'LG bracket', 32.23);
INSERT INTO wall_bracket (id, size, ajustable, name, price) VALUES (1003, '25X25', false, 'Philips bracket', 32.23);
INSERT INTO wall_bracket (id, size, ajustable, name, price) VALUES (1004, '25X32/32X40', true, 'Nikkei bracket', 32.23);
INSERT INTO wall_bracket (id, size, ajustable, name, price) VALUES (1005, '25X32', false, 'Nikkei bracket', 32.23);
